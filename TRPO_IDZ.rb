...
=begin
Максим, адаптер объекта подразумевает, что мы приспосабливаем экземпляры текущего класса и всех его возможных наследников к интерфейсу другого класса. 
Можете показать, что наследники полярных тоже адаптированы к декартовым через ваш адаптер? А так все хорошо, жду общую часть лабораторки по паттернам
P.S. Код на Ruby заценила
=end
